...
protocol AddPresenterOutputProtocol {
    init(view: CityAdd_VC, modelManager: ModelManagerProtocol, router: RouterProtocol, isEditingMode: Bool)
...
class AddPresenter: AddPresenterOutputProtocol {
    ...
    func setupDataForEdditing() {
        modelManager.specificCity(id: id!) { result in
            switch result {
    ...
    weak var view: CityAdd_VC?
    var router: RouterProtocol?
    let modelManager: ModelManagerProtocol!
    let isEditingMode: Bool?
    let id: String?
    
    required init(view: CityAdd_VC, modelManager: ModelManagerProtocol, router: RouterProtocol, isEditingMode: Bool) {
        self.view = view
    ...
    required init(view: CityAdd_VC, modelManager: ModelManagerProtocol, router: RouterProtocol, isEditingMode: Bool, id: String) {
        self.view = view
        self.modelManager = modelManager
        self.router = router
        self.isEditingMode = isEditingMode
